...
export const RestaurantDetail = () => {
  ...
  const { id } = useParams();
  const [restaurants, setRestaurants] = useState(store.restaurantes);
  ...
  useEffect(() => {
    ...
    const foundRestaurant = restaurants.filter(r => {
    ...
    if (foundRestaurant) {
      console.log("existe")
      setRestaurant(foundRestaurant[0]);
      setLoading(false);
    } else {
  ...
  return (
    <div className="restaurant-detail-main-container">
      <div className="restaurant-detail-container">
        ...
        <p>
          <i className="fas fa-utensils" style={{ color: "#232323" }}></i> Tipo de comida: {restaurant?.categoria_id}
        </p>
        <p>
          <i className="fas fa-map-marker-alt" style={{ color: "#232323" }}></i> Dirección: {restaurant?.direccion}
        </p>
        <p>
          <strong>Valoración:</strong> {restaurant?.valoracion} ⭐
        </p>
        <p>
          <i className="fas fa-dollar-sign" style={{ color: "#232323" }}></i> Rango de Precios: {restaurant?.priceRange}
        </p>
        <img src={restaurant?.image} alt={restaurant?.nombre} />
      </div>
